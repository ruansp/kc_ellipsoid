...
% Validation of containment for SE(3) configurations
%
% Inputs:
%  Z       : A list of configurations, Nx6 array
%  a       : Semi-axes lengths of the moving ellipsoid, 3D vector
%  infla   : Inflation factor
%
% Outputs:
%  Z_valid : A list of valid configurations for containment
% 
